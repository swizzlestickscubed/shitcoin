...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Shitcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // SHITCOIN: 3.5 days
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x92ddd96d0bd6360c63351edec9a9c7d446db6b215eb9e234ae3b1f81eed4cd6b");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "noice";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 10 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("40c08226b548010a309d8eb8d5b4c6d428835ca5448ff24eab9ca85ad7f612e287d72971e205bf3166f7c5df3c96b86beac8ee89491e3063ad38b43a8803bbf61a") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 00000000000000000000;
        ...
        if (fTestNet)
        {
            block.nTime    = 1501688298;
            block.nNonce   = 1377674;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xa53cb95d126b203028c14bac60247b6850f08e22f97d6ba72bab44c7a0bf034c"));
	//
...
unsigned char pchMessageStart[4] = { 0xa1, 0xc3, 0xb1, 0xd4 }; // Shitcoin: increase each by adding 2 to bitcoin's value.
