...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x295a72becf32e2ca20e8b6e5b77ceb33d9fefa8f8c4708bbacb1bbaa1c59ccac");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1495058864;
        block.nBits    = 504365644;
        block.nNonce   = 2533318534;

        if (fTestNet)
        {
            block.nTime    = 1495058864;
            block.nNonce   = 2402572274;
        }
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Shitcoin: increase each by adding 2 to bitcoin's value.
